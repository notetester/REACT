...
## 🚀 라이브 데모
- **[Zustand 상태관리 데모 (my-app02)](demo/zustand/)** — 로그인·Todo·메모·프로필 (백엔드 없이 동작)

## 🧰 기술 스택
React 19 · React Router v7 · Zustand 5 · Axios · MUI / Spring Boot · Spring Security · JWT(jjwt) · MyBatis · Java 21 · Gradle
